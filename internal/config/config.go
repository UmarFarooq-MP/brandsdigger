...
const (
	...
	GODADDY_BASE_URL   = "godaddy.api.url"
...
func Init() {
	_ = viper.BindEnv(GODADDY_API_KEY, "API_KEY")
	_ = viper.BindEnv(GODADDY_API_SECRET, "API_SECRET")
	_ = viper.BindEnv(GODADDY_BASE_URL, "BASE_URL")
